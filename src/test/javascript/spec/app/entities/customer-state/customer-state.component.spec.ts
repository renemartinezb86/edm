...
import { CustomerStateComponent } from 'app/entities/customer-state/customer-state.component';
...
describe('Component Tests', () => {
    describe('CustomerState Management Component', () => {
        let comp: CustomerStateComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [CustomerStateComponent],
                providers: [
                    {
                ...
                .overrideTemplate(CustomerStateComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.customerStates[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
